;;; rose-pine-theme.el --- A beautiful theme -*- lexical-binding: t; -*-
;;; Commentary:
...
(autothemer-deftheme
 ...
 (
  ...
  (whitespace-indentation               (:foreground muted :background surface))
  (whitespace-tab                       (:foreground muted :background surface))
  (whitespace-space-after-tab           (:foreground muted :background surface))
  (whitespace-space-before-tab          (:foreground muted :background surface))
  ...
  ;; Upstream set :foreground to `surface' (dark) on a dark `overlay' background,
  ;; making the selected candidate unreadable.  Use the light `text' color.
  (vertico-current                              (:background overlay :distant-foreground text :bold t :foreground text))
